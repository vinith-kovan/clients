...
import { MovePoliciesToStateProviderMigration } from "./migrations/10-move-policies-to-state-provider";
...
export async function migrate(
  ...
  MigrationBuilder.create()
    ...
    .with(MovePoliciesToStateProviderMigration, 9, CURRENT_VERSION)
